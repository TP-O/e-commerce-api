...
import { AdminForgotPasswordController } from '@app/controllers/auth';
import { createRequest, createResponse } from 'node-mocks-http';

describe('Test AdminForgotPasswordController', () => {
  ...
  const controller = new AdminForgotPasswordController(
    new Service(),
    new Validator(),
    new Validator(),
  );
