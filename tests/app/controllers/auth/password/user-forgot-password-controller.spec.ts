...
import { UserForgotPasswordController } from '@app/controllers/auth';
import { createRequest, createResponse } from 'node-mocks-http';

describe('Test UserForgotPasswordController', () => {
  ...
  const controller = new UserForgotPasswordController(
    new Service(),
    new Validator(),
    new Validator(),
  );
