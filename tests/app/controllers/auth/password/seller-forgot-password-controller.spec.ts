...
import { SellerForgotPasswordController } from '@app/controllers/auth';
import { createRequest, createResponse } from 'node-mocks-http';

describe('Test SellerForgotPasswordController', () => {
  ...
  const controller = new SellerForgotPasswordController(
    new Service(),
    new Validator(),
    new Validator(),
  );
