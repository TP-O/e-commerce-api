...
import { CustomerVerifyController } from '@app/controllers/auth';
import { createRequest, createResponse } from 'node-mocks-http';

describe('Test CustomerVerifyController', () => {
  ...
  const controller = new CustomerVerifyController(new Service());
