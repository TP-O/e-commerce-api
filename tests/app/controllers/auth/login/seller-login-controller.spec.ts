...
import { SellerLoginController } from '@app/controllers/auth';

describe('Test SellerLoginController', () => {
  ...
  const controller = new SellerLoginController(new Service(), new Validator());
