...
import { UserLoginController } from '@app/controllers/auth';

describe('Test UserLoginController', () => {
  ...
  const controller = new UserLoginController(new Service(), new Validator());
