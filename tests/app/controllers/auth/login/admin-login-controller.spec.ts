...
import { AdminLoginController } from '@app/controllers/auth';

describe('Test AdminLoginController', () => {
  ...
  const controller = new AdminLoginController(new Service(), new Validator());
