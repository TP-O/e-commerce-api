...
export class AdvertisementStrategiesSeeder extends Seeder {
  ...
  protected async run() {
    await this.database.table('advertisement_strategies').insert(
      ...
      ['9','2', 'Sale Off For TV', 'sale-off-for-tv', '20', '30', '2021-05-25 00:00:00', '2021-06-25 00:00:00'],
      ['11','2', 'Sale Off For Fridge', 'sale-off-for-fridge', '20', '30', '2021-05-25 00:00:00', '2021-06-25 00:00:00'],
